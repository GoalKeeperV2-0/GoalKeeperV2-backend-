...
insert into goal (dtype, id, content, goal_state, point, reward, title, category, user_id) values  ('OneTimeGoal', 1, 'test', 'ONGOING', 100, 'HIGH_RETURN', 'test', 'STUDY', 1),('ManyTimeGoal', 2, 'dd', 'ONGOING', 100, 'HIGH_RETURN', 'dd', 'STUDY', 1);
insert into one_time_goal (end_date, id) values  ('2023-03-03', 1);
insert into many_time_goal (end_date, start_date, success_count, id) values  ('2023-03-13', '2023-03-09', 0, 2);

...
//        Page<ManyTimeCertificationResponse> result = certificationGetService.getCertificationsByCategory(categoryType,page).map(ManyTimeCertificationResponse::new);
...
//        Page<ManyTimeCertificationResponse> result = certificationGetService.getManyTimeCertifications(page).map(ManyTimeCertificationResponse::new);
//        Response<Page<ManyTimeCertificationResponse>> response = new Response<>("카테고리별 지속목표 인증 조회에 성공했습니다.",result);
//        return ResponseEntity.ok(response);
//    }
//
...
//        Page<ManyTimeCertificationResponse> result = certificationGetService.getCertificationsByGoalId(goalId,page).map(ManyTimeCertificationResponse::new);
